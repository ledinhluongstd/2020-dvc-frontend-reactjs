...
class HomePublicCategorySearchStatistics extends Component {
  constructor(props) {
    super(props)
    this.state = {
      data: {},
  ...
  _init = async () => {
    ...
    let axiosReq = [
      dashboardServices.publicCategorySearchStatistics(query),
    ]
    ...
    return (
      <div className="col-xl-12">
        <div className="card mb-4">
          <div className="card-header"><i className="fas fa-chart-bar mr-1"></i>Thống kê lượt sử dụng danh mục (trong 10 ngày)</div>
...
export default connect(mapStateToProps)(HomePublicCategorySearchStatistics);
