...
class DichVuCungCapChiTiet extends Component {
  constructor(props) {
    super(props)
    this.state = {
      danhsach: data,//[],
      ...
      return (
        <React.Fragment>
          <div className="main portlet">
            <BreadCrumbs title={"Danh sách đơn vị"} route={[{ label: 'Chi tiết dịch vụ cung cấp', value: '/dich-vu-cung-cap/chi-tiet' }]} />
            <div className="portlet-title">
              <div className="caption">
                <h5 className='text-info'>
                    <i className="fas fa-layer-group" />CHI TIẾT DỊCH VỤ
                </h5>
              </div>
                        
            </div>
            <span className='td-nhom'>Nhóm: Dịch vụ QLVB</span> <br />
              <span className='td-url'>Url: https://api.quangnam.gov.vn/dvqlvb/1.0</span><br />
              <span className='td-version'>Version: 1.0</span><br />
              <span className='td-dangky'>Đăng ký: 2</span><br />
          ...
          <div style={{backgroundColor:'#f0f0f0',fontSize:'4px'}}><span style={{color:'#f0f0f0'}}>1</span></div>

          <div className="main portlet">          
            <span className='td-nhom'>Mô tả:</span> <br />
          </div>

          <div style={{backgroundColor:'#f0f0f0',fontSize:'4px'}}><span style={{color:'#f0f0f0'}}>1</span></div>

          <div className="main portlet" style={{backgroundColor:'#e5eceb'}}>          
            <span className='td-nhom'>   1.Thống kê giao dịch:</span> 
          </div>

          <div style={{backgroundColor:'#f0f0f0',fontSize:'4px'}}><span style={{color:'#f0f0f0'}}>1</span></div>

          <div className="main portlet" >          
            <span className='td-nhom' style={{marginRight:'20px',color:'#0457a7',marginLeft:'20px'}}> Tất cả </span> 
            <span className='td-nhom' style={{marginRight:'20px'}}> Năm </span> 
            <span className='td-nhom' style={{marginRight:'20px',color:'#0457a7'}}> Tháng </span> 
            <span className='td-nhom' style={{marginRight:'20px',color:'#0457a7'}}> Tuần </span> 
            <span className='td-nhom' style={{marginRight:'20px',color:'#0457a7'}}> Ngày </span> 
            <span className='td-nhom'style={{color:'#0457a7'}}> 24h gần nhất </span> 
                      ...
                      {danhsach.map((item, index) => {
                        return <tr key={index} >
                          ...
                          <td style={{textAlign:'right',width:'15%'}}>
                            <br/>
                            <Link to={'/dich-vu-cung-cap/chi-tiet'} title="Chi tiết" className="btn btn-sm btn-outline-info border-radius"><i className="fas fa-pencil-alt" /></Link><br/><br/><br/>
...
export default connect(mapStateToProps)(DichVuCungCapChiTiet);
